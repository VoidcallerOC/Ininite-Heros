...
import type { ContentRevision, MediaAsset, PageSection } from '@/lib/cms';
...
export default async function HomepageAdminPage() {
  ...
  const mediaResult = await supabase.from('media').select('*').order('created_at', { ascending: false });
